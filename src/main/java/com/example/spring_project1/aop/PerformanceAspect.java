package com.example.spring_project1.aop;
...
public class PerformanceAspect {
    ...
    // 특정 어노테이션을 대상 지정
    @Pointcut("@annotation(com.example.spring_project1.annotation.RunningTime)")
    private void enableRunningTime(){}

    // 기본 패키지의 모든 메소드
    @Pointcut("execution(* com.example.spring_project1..*.*(..))")
    private void cut() {}
